...
usersMapped = users1.map((element) => ({
...
function getAverageAge(arr) {
  let sum = 0;
  arr.forEach((item) =>
    item["age"] ? (sum += item["age"]) : alert("Не существует данных")
  );
...
// а это задания, которые дали на дом после семинара от 16.01.24 , создать Ффункции getBalance() и listAccounts()
let accounts = [
  {
    id: 14,
    holderName: "Dinara",
